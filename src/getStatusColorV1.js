...
export const getStatusColorV1 = (child) => {
    ...
    const objColors = getColorsV1().objColors;
...
export const getStatusColorSingleV1 = (onHold,  status, parentHold ) => {
